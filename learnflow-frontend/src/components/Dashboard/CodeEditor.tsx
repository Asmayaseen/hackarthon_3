  ...
  return (
    <div className="grid grid-cols-2 gap-4 h-[calc(100vh-220px)]">
      ...
      <div className="flex flex-col gap-3">
        {/* Terminal output */}
        <div className="bg-gray-950 border border-gray-800 rounded-xl overflow-hidden flex flex-col flex-1">
          ...
          <div className="flex-1 p-4 font-mono text-sm overflow-y-auto">
            ...
            {running && <p className="text-yellow-400">Running...</p>}
        ...
        {/* AI Review panel */}
        {(review || reviewing) && (
          <div className="bg-gray-900 border border-purple-800/50 rounded-xl overflow-hidden flex flex-col max-h-[45%]">
